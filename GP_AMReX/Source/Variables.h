...
Vector<Real> cubepat;
Vector<Real> voronoi2D;
Vector<Real> voronoi3D;
...
void (*Iterative_stress_solver)(MultiFab& phi_old, MultiFab& disp_X, MultiFab& disp_Y, MultiFab& disp_Z, MultiFab& strain_X, MultiFab& strain_Y, MultiFab& strain_Z, Geometry const& geom);
...
Vector<Vector<Real>> conc_s;
Vector<Vector<Real>> conc_l;
Vector<Vector<Real>> conceq_s;
Vector<Vector<Real>> conceq_l;
